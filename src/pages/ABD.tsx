                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                        <div>
                            ...
                            <p className='text-lg leading-relaxed mb-10 font-light'>
                                ...
                                adviseur binnen het ABD programma. Leer
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-16'>
                        ...
                        <p className='text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light'>
                            Het ABD (Algemene Bestuursdienst) programma vormt
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                        <div>
                            <h2 className='text-4xl font-semibold text-slate-800 mb-8'>
                                Kernvaardigheden voor ABD'ers
                            </h2>
                            <p className='text-lg text-gray-600 mb-10 leading-relaxed font-light'>
                                Als ABD'er bent u de spil tussen politieke
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-16'>
                        ...
                        <p className='text-xl text-gray-600 max-w-4xl mx-auto font-light'>
                            ...
                            ontworpen voor ABD'ers en hun unieke uitdagingen in
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        <div className='bg-white border-2 border-slate-200 p-8 rounded-none shadow-sm'>
                            ...
                            <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                ...
                                van de ABD'er in het bestuurlijke stelsel.
                            </p>
