                            ...
                            <div className='space-y-10'>
                                <div>
                                    ...
                                    <p className='text-lg text-gray-600 leading-relaxed mb-10 font-light'>
                                        We staan klaar om uw vragen te
                                        beantwoorden en u te helpen bij het
                                        vinden van het juiste programma voor uw
                                        ontwikkeling of organisatie.
                                    </p>
                                </div>
                                ...
                                <div className='bg-slate-50 p-8 rounded-none border border-slate-200'>
                                    ...
                                    <p className='text-slate-700 font-light'>
                                        ...
                                        reageren op uw aanvraag. Voor
                                        spoedeisende zaken kunt u direct bellen.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value='lecture'>
                                                Lecture - Programma Doorgroeien
                                                in Leiderschap
                                            </option>
                                            <option value='comenius'>
                                                Comenius - Emerging Leaders
                                                Leergang
                                            </option>
                                            <option value='ABR'>
