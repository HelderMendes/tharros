                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                        <div>
                            ...
                            <p className='text-xl text-slate-100 mb-8 font-light'>
                                Programma Doorgroeien in Leiderschap (incompany)
                            </p>
                            <p className='text-lg leading-relaxed mb-10 font-light'>
                                ...
                                Ontdek wie je bent, wat je drijft en hoe je je
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                        ...
                        <div>
                            ...
                            <p className='text-lg text-gray-600 mb-8 leading-relaxed font-light'>
                                Het fundament van goed leiderschap begint bij
                                zelfkennis. In dit programma duiken we diep in
                                wie je bent als persoon en als leider, wat je
                                drijft en hoe je je natuurlijke talenten
                            ...
                            <div className='space-y-6'>
                                ...
                                <div className='flex items-start space-x-4'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-600 font-light'>
                                            Identificeer je kernwaarden en hoe
                                            deze je leiderschapsgedrag
                                            beïnvloeden
                                        </p>
                                    </div>
                                </div>
                                <div className='flex items-start space-x-4'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-600 font-light'>
                                            Inzichten van collega's, medewerkers
                                            en stakeholders
                                        </p>
                                    </div>
                                </div>
                ...
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-16'>
                        ...
                        <p className='text-xl text-gray-600 max-w-4xl mx-auto font-light'>
                            Een zorgvuldig samengesteld traject van zes maanden,
                            waarbij theorie en praktijk hand in hand gaan voor
                            maximale impact.
                        </p>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                        <div className='bg-white p-8 rounded-none shadow-sm border border-gray-200'>
                            ...
                            <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                Uitgebreide assessment, persoonlijkheidsanalyse
                                en 360-graden feedback. Fundamentele zelfkennis
                                opbouwen.
                            </p>
                        ...
                        <div className='bg-white p-8 rounded-none shadow-sm border border-gray-200'>
                            ...
                            <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                Toepassing in de dagelijkse praktijk, follow-up
                                sessies en borging van het geleerde voor
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                        <div>
                            ...
                            <p className='text-lg text-gray-600 mb-10 leading-relaxed font-light'>
                                ...
                                teamresultaten en persoonlijke voldoening in je
                                rol als leider.
                            </p>
                            ...
                            <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
                                ...
                                <div className='space-y-6'>
                                    <div>
                                        ...
                                        <ul className='text-gray-600 space-y-2 font-light'>
                                            <li>• Effectievere communicatie</li>
                                            <li>• Betere besluitvorming</li>
                                            <li>• Verhoogde teamperformance</li>
                                            <li>• Meer invloed en impact</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
