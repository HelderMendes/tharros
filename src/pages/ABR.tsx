                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                            <div>
                                ...
                                <p className='text-lg leading-relaxed mb-10 font-light'>
                                    Training voor de rol van politiek en
                                    ambtelijk adviseur binnen het ABR programma.
                                    Leer effectief en krachtig je adviserende
                                    rol in te vullen in de complexe dynamiek
                                    tussen politiek en ambtelijke organisatie.
                                </p>
                    ...
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        <div className='text-center mb-16'>
                            ...
                            <p className='text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light'>
                                Het ABR (Algemene Bestuursdienst) programma
                                vormt topambtenaren die de brug slaan tussen
                                politiek en uitvoering. Onze training bereidt u
                                voor op deze cruciale rol in het hart van de
                                democratie.
                            </p>
                        </div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                            <div className='bg-gradient-to-br from-slate-50 to-slate-100 p-8 rounded-none border border-slate-200'>
                                ...
                                <p className='text-gray-600 font-light leading-relaxed'>
                                    Ontwikkel een sterke professionele
                                    identiteit als topambtenaar, gebaseerd op
                                    onpartijdigheid, integriteit en vakmanschap.
                                </p>
                            </div>
                            ...
                            <div className='bg-gradient-to-br from-slate-50 to-slate-100 p-8 rounded-none border border-slate-200'>
                                ...
                                <p className='text-gray-600 font-light leading-relaxed'>
                                    Leer navigeren in de politieke arena met
                                    respect voor democratische processen en
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                            <div>
                                ...
                                <p className='text-lg text-gray-600 mb-10 leading-relaxed font-light'>
                                    ...
                                    ambities en ambtelijke realiteit. Ons
                                    programma rust u uit met de unieke
                                    vaardigheden die nodig zijn voor deze
                                    uitdagende positie.
                                </p>
                                ...
                                <div className='space-y-6'>
                                    ...
                                    <div className='flex items-start space-x-4'>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-gray-600 font-light'>
                                                Effectief samenwerken met
                                                politici, ambtenaren en externe
                                                partijen
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex items-start space-x-4'>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-gray-600 font-light'>
                                                Overtuigend presenteren en
                                                adviseren op het hoogste niveau
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        <div className='text-center mb-16'>
                            ...
                            <p className='text-xl text-gray-600 max-w-4xl mx-auto font-light'>
                                Een intensief 4-maanden durend programma,
                                specifiek ontworpen voor ABR'ers en hun unieke
                                uitdagingen in de politiek-ambtelijke context.
                            </p>
                        </div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                            <div className='bg-white border-2 border-slate-200 p-8 rounded-none shadow-sm'>
                                ...
                                <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                    ...
                                    democratische legitimiteit en de unieke
                                    positie van de ABR'er in het bestuurlijke
                                    stelsel.
                                </p>
                            ...
                            <div className='bg-white border-2 border-slate-200 p-8 rounded-none shadow-sm'>
                                ...
                                <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                    Praktische vaardigheden voor het analyseren
                                    van complexe beleidsvraagstukken en het
                                    formuleren van heldere adviezen.
                                </p>
                                <ul className='text-sm text-gray-500 space-y-2 font-light'>
                            ...
                            <div className='bg-white border-2 border-slate-200 p-8 rounded-none shadow-sm'>
                                ...
                                <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                    Navigeren in complexe netwerken van
                                    politici, ambtenaren, media en
                            ...
                            <div className='bg-white border-2 border-slate-200 p-8 rounded-none shadow-sm'>
                                ...
                                <p className='text-gray-600 mb-6 font-light leading-relaxed'>
                                    Ontwikkeling van authentiek leiderschap
                                    onder politieke druk, met focus op
                                    integriteit en professionele waarden.
                                </p>
                                <ul className='text-sm text-gray-500 space-y-2 font-light'>
                ...
                <section className='py-20 bg-slate-800'>
                    <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
                        ...
                        <p className='text-xl text-slate-100 mb-10 leading-relaxed font-light'>
                            ...
                            heeft om effectief te adviseren en leiding te geven
                            in de complexe wereld van politiek en bestuur.
                        </p>
